Locales['sv'] = {
  ...
  ['service_max'] = 'Maximala poliser i tjänst: ',
  -- Action Menu
  ['citizen_interaction'] = 'Handlingar mot civila',
  ['vehicle_interaction'] = 'Handlingar på bilar',
  ['object_spawner'] = 'sätt ut ett objekt',

  ['id_card'] = 'Identitets-Kort',
  ['search'] = 'Visitera',
  ['handcuff'] = 'Sätt handfängsel',
  ['drag'] = 'Släpa',
  ['put_in_vehicle'] = 'Sätt in i fordonet',
  ['out_the_vehicle'] = 'Ta ut ur fordonet',
  ['fine'] = 'Skriv böter',
  ['license_check'] = 'Kolla licenser',
  ...
  ['pick_lock'] = 'Bryt upp fordonet',
  ['vehicle_unlocked'] = 'fordon ~g~upplåst~s~',
  ['no_vehicles_nearby'] = 'Inga fordon i närheten',
  ['impound'] = 'Beslagta fordonet',
  ['impound_prompt'] = 'tryck ~INPUT_CONTEXT~ för att avbryta ~y~beslagtagningen~s~',
  ['impound_canceled'] = 'du avbröt beslagtagningen',
  ['impound_canceled_moved'] = 'beslagtagningen avbröts på grund av att fordonet har rört på sig',
  ['impound_successful'] = 'du har beslagtagit detta fordonet',
  ...
  ['search_database_error_not_found'] = 'det ~y~registreringsnummeret~s~ är ~r~inte~s~ registrerat till någon!',
